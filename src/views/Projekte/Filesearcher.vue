        ...
        <div class="container py-0 pb-lg">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <h1 class="text-white font-weight-light">{{ $t('filesearcher_ü') }}</h1>
                    <p class="lead text-white mt-4">{{ $t('filesearcher_t') }}</p>
                    <a href="https://www.filesearcher.online"
                       class="btn btn-white mt-4">{{ $t('filesearcher_b') }}</a>
                </div>
